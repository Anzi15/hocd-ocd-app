...
import { Play, BookOpen, Library, Settings, LogIn } from "lucide-react"
    ...
    <div className="min-h-screen relative">
      ...
      <header className="relative z-10 flex justify-between items-center p-4">
        <div className="flex items-center space-x-2">
          ...
          <h1 className="text-2xl font-bold text-gray-800 font-heading">Breakup Guide</h1>
        </div>

        <div className="flex items-center space-x-2">
          <Button variant="ghost" size="sm" onClick={() => setShowSettings(true)} className="animate-button-press">
          ...
          {user ? (
            <div className="flex items-center space-x-2">
              <Avatar className="h-8 w-8 cursor-pointer" onClick={handleSignOut}>
                ...
                <AvatarFallback className="text-xs font-body">{getUserInitials(user.email || "U")}</AvatarFallback>
              </Avatar>
            ...
            <Button variant="ghost" size="sm" onClick={() => setShowAuthModal(true)} className="animate-button-press">
        ...
        <div className=" mx-auto space-y-8">
          ...
          <Card className="animate-scale-hover">
            <CardContent className="p-6">
              <h2 className="text-2xl font-bold mb-4 text-center font-heading">Welcome to Your Learning Journey</h2>
              <div className="flex justify-center">
              </div>
              <p className="text-center text-gray-600 mt-4 font-body">
                Discover personalized learning paths through interactive questions and curated content.
              </p>
            </CardContent>
          </Card>
<div className="max-w-3xl mx-auto rounded-xl overflow-hidden shadow-xl aspect-video">
  <iframe
    ...
    src="https://www.youtube.com/embed/CjNRgEMrlrg"
    title="Intro Video"
    frameBorder="0"
  ...
  ></iframe>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
            <Card className="animate-scale-hover">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-semibold mb-2 font-heading">10 Learning Chapters</h3>
            ...
            <Card className="animate-scale-hover">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-semibold mb-2 font-heading">Interactive Questions</h3>
                <p className="text-gray-600 text-sm font-body">Personalized learning based on your responses</p>
              </CardContent>
            </Card>
            ...
            <Card className="animate-scale-hover">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-semibold mb-2 font-heading">Curated Library</h3>
                <p className="text-gray-600 text-sm font-body">Access your purchased content anytime, anywhere</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <SettingsPanel isOpen={showSettings} onClose={() => setShowSettings(false)} onSettingsChange={setSettings} />
    </div>
  )
}
